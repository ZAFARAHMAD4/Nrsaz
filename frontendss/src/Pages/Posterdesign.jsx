...
// Import images
import logo1 from '../Images/posterdesign5.png';
import logo2 from '../Images/posterdesign2.png';
...
function Posterdesign() {
  ...
  const galleryImages = [
    ...
    logo7, logo8, logo9, logo10, logo11, logo12,logo14,logo15,logo17,logo18,logo21,logo22,logo23,logo24,
    ,logo26,logo27,logo29,logo30,logo31,logo33,logo34,logo39,logo40
  ];

  return (
    <div className="logo-gallery-page">
      <h1 className="gallery-title" data-aos="fade-up">Gallery of Poster Design</h1>
